...
export const levels: Level[] = [
  ...
  },
  {
    ...
    description: "Combine turns and movement to cross the training grid.",
    grid: [
      ["wall", "start", "wall", "wall", "wall"],
      ["wall", "floor", "floor", "floor", "wall"],
      ["wall", "wall", "wall", "floor", "wall"],
  ...
  },
  {
    id: "signal-hunt",
    name: "Signal Hunt",
    description: "Read the maze and choose a route instead of guessing.",
    grid: [
  ...
  },
  {
    id: "warehouse-run",
    name: "Warehouse Run",
    description: "Navigate a larger route with repeated sections.",
    grid: [
      ["wall", "start", "wall", "wall", "wall", "wall"],
  ...
  },
  {
    id: "final-maze",
    name: "The Final Maze",
    description: "Use everything you learned to reach the beacon with clean logic.",
    grid: [
      ["wall", "start", "floor", "floor", "floor", "wall"],
      ["wall", "floor", "wall", "wall", "floor", "wall"],
      ["wall", "floor", "floor", "floor", "floor", "wall"],
      ["wall", "wall", "wall", "wall", "floor", "wall"],
      ["wall", "wall", "wall", "goal", "floor", "wall"],
    ],
    startPosition: { x: 1, z: 0 },
    startDirection: 0,
    starterCode: "",
