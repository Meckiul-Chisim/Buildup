  ...
  return (
    <ScrollView className="flex-1 bg-[#08101f]" contentContainerStyle={{ flexGrow: 1, justifyContent: "center", padding: 24 }}>
      ...
      <View className="mt-8 rounded-3xl border border-slate-800 bg-[#101827] p-5">
        ...
        <Pressable onPress={() => router.replace("/home")} className="mt-2 rounded-2xl border border-slate-700 px-4 py-3">
          <Text className="text-center text-sm font-bold text-slate-300">Continue without an account</Text>
        </Pressable>
      </View>
    </ScrollView>
  );
